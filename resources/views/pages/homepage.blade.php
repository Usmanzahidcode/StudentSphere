            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-12">
                    <div class="about-image-wrap custom-border-radius-start">
                        <img src="{{asset('assets/images/professional-asian-businesswoman-gray-blazer.jpg')}}"
                ...
                <div class="col-lg-6 col-12">
                    <div class="custom-text-block">
                        ...
                        <p class="text-white">Gotto Job is a free website template for job portals. This layout is based
                            on Bootstrap 5 CSS framework. Thank you for visiting <a href="https://www.tooplate.com"
                                                                                    target="_parent">Tooplate
                                website</a>. Images are from <a href="https://www.freepik.com/"
                                                                target="_blank">FreePik</a> website.</p>
                ...
                <div class="col-lg-3 col-12">
                    <div class="instagram-block">
                        <img src="{{asset('assets/images/horizontal-shot-happy-mixed-race-females.jpg')}}"
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-12 text-center mx-auto mb-4">
                    ...
                    <p><strong>Over 10k opening jobs</strong> Feel free to download and use our free HTML templates from
                        Tooplate website.</p>
                </div>
                ...
                <div class="col-lg-12 col-12">
                    ...
                    <div class="job-thumb d-flex">
                        <div class="job-image-wrap bg-white shadow-lg">
                            <img src="{{asset('assets/images/logos/creative-market.png')}}" class="job-image img-fluid"
                                 alt="">
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12">
                    <div class="custom-text-block custom-border-radius-start">
                        ...
                        <p class="text-white">You are not allowed to redistribute the template ZIP file on any other
                            template collection website. Please contact us for more info. Thank you.</p>
                ...
                <div class="col-lg-6 col-12">
                    <div class="video-thumb">
                        <img src="{{asset('assets/images/people-working-as-team-company.jpg')}}"
                             class="about-image custom-border-radius-end img-fluid" alt="">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-12 mb-4">
                    ...
                    <p><strong>Over 10k opening jobs</strong> Lorem Ipsum dolor sit amet, consectetur adipsicing kengan
                        omeg kohm tokito adipcingi elit eismuod larehai</p>
                </div>
                    ...
                    <div class="job-thumb job-thumb-box">
                        <div class="job-image-box-wrap">
                            <a href="../job-details.html">
                                <img src="{{asset('assets/images/jobs/it-professional-works-startup-project.jpg')}}"
                        ...
                        <div class="job-body">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                    <img src="{{asset('assets/images/logos/salesforce.png')}}"
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="job-thumb job-thumb-box">
                        <div class="job-image-box-wrap">
                            <a href="../job-details.html">
                                <img src="{{asset('assets/images/jobs/marketing-assistant.jpg')}}"
                        ...
                        <div class="job-body">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                    <img src="{{asset('assets/images/logos/spotify.png')}}"
                                         class="job-image me-3 img-fluid" alt="">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="job-thumb job-thumb-box">
                        <div class="job-image-box-wrap">
                            <a href="../job-details.html">
                                <img src="{{asset('assets/images/jobs/coding-man.jpg')}}" class="job-image img-fluid"
                                     alt="">
                            </a>
                        ...
                        <div class="job-body">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                    <img src="{{asset('assets/images/logos/twitter.png')}}"
                                         class="job-image me-3 img-fluid" alt="">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="job-thumb job-thumb-box">
                        <div class="job-image-box-wrap">
                            <a href="../job-details.html">
                                <img src="{{asset('assets/images/jobs/pretty-blogger-posing-cozy-apartment.jpg')}}"
                                     class="job-image img-fluid" alt="">
                            </a>
                        ...
                        <div class="job-body">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                    <img src="{{asset('assets/images/logos/yelp.png')}}"
                                         class="job-image me-3 img-fluid" alt="">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="job-thumb job-thumb-box">
                        <div class="job-image-box-wrap">
                            <a href="../job-details.html">
                                <img src="{{asset('assets/images/jobs/paper-analysis.jpg')}}"
                                     class="job-image img-fluid" alt="">
                            </a>
                        ...
                        <div class="job-body">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                    <img src="{{asset('assets/images/logos/paypal.png')}}"
                                         class="job-image me-3 img-fluid" alt="">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="job-thumb job-thumb-box">
                        <div class="job-image-box-wrap">
                            <a href="../job-details.html">
                                <img src="{{asset('assets/images/jobs/logo-designer-working-computer-desktop.jpg')}}"
                                     class="job-image img-fluid" alt="">
                            </a>
                        ...
                        <div class="job-body">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                    <img src="{{asset('assets/images/logos/envato.png')}}"
                                         class="job-image me-3 img-fluid" alt="">
                    ...
                    <div class="owl-carousel owl-theme reviews-carousel">
                        <div class="reviews-thumb">
                            ...
                            <div class="reviews-info d-flex align-items-center">
                                <img
                                    src="{{asset('assets/images/avatar/portrait-charming-middle-aged-attractive-woman-with-blonde-hair.jpg')}}"
                            ...
                            <div class="reviews-body">
                                <img src="{{asset('assets/images/left-quote.png')}}" class="quote-icon img-fluid"
                                     alt="">
                        ...
                        <div class="reviews-thumb">
                            <div class="reviews-info d-flex align-items-center">
                                <img src="{{asset('assets/images/avatar/medium-shot-smiley-senior-man.jpg')}}"
                                     class="avatar-image img-fluid" alt="">
                        ...
                        <div class="reviews-thumb">
                            ...
                            <div class="reviews-info d-flex align-items-center">
                                <img src="{{asset('assets/images/avatar/portrait-beautiful-young-woman.jpg')}}"
                                     class="avatar-image img-fluid" alt="">
                        ...
                        <div class="reviews-thumb">
                            <div class="reviews-info d-flex align-items-center">
                                <img src="{{asset('assets/images/avatar/blond-man-happy-expression.jpg')}}"
                                     class="avatar-image img-fluid" alt="">
                        ...
                        <div class="reviews-thumb">
                            <div class="reviews-info d-flex align-items-center">
                                <img
                                    src="{{asset('assets/images/avatar/university-study-abroad-lifestyle-concept.jpg')}}"
                                    class="avatar-image img-fluid" alt="">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-10">
                    ...
                    <p class="text-white">If you are looking for free HTML templates, you may visit Tooplate website. If
                        you need a collection of free templates, you can visit Too CSS website.</p>
                </div>
